...
urlpatterns = [
    ...
    path(
        "fleet/<int:fleet_pk>/wing/<int:wing_id>/rename/",
        views.rename_wing,
        name="rename_wing",
    ),
    path(
        "fleet/<int:fleet_pk>/wing/<int:wing_id>/delete/",
        views.delete_wing,
        name="delete_wing",
    ),
    path(
        "fleet/<int:fleet_pk>/wing/<int:wing_id>/squad/create/",
        views.create_squad,
        name="create_squad",
    ),
    path(
        "fleet/<int:fleet_pk>/squad/<int:squad_id>/rename/",
        views.rename_squad,
        name="rename_squad",
    ),
    path(
        "fleet/<int:fleet_pk>/squad/<int:squad_id>/delete/",
        views.delete_squad,
        name="delete_squad",
    ),
    path(
        "fleet/<int:fleet_pk>/members.json",
        views.fleet_members_json,
        name="fleet_members_json",
    ),
    ...
    path(
        "layout/wing/<int:pk>/rename/",
        views.rename_layout_wing,
        name="rename_layout_wing",
    ),
    path(
        "layout/wing/<int:pk>/delete/",
        views.delete_layout_wing,
        name="delete_layout_wing",
    ),
    path(
        "layout/wing/<int:pk>/squad/add/",
        views.add_layout_squad,
        name="add_layout_squad",
    ),
    path(
        "layout/squad/<int:pk>/rename/",
        views.rename_layout_squad,
        name="rename_layout_squad",
    ),
    path(
        "layout/squad/<int:pk>/delete/",
        views.delete_layout_squad,
        name="delete_layout_squad",
    ),
    path(
        "fleet/<int:fleet_pk>/apply-layout/<int:layout_pk>/",
        views.apply_layout,
        name="apply_layout",
    ),
    # MOTD Templates
    path(
        "motd-template/create/", views.create_motd_template, name="create_motd_template"
    ),
    path(
        "motd-template/<int:pk>/update/",
        views.update_motd_template,
        name="update_motd_template",
    ),
    path(
        "motd-template/<int:pk>/delete/",
        views.delete_motd_template,
        name="delete_motd_template",
    ),
    # Integrations
    path(
        "fleet/<int:fleet_pk>/fat-link/create/",
        views.create_fat_link,
        name="create_fat_link",
    ),
    path(
        "fleet/<int:fleet_pk>/srp-link/create/",
        views.create_srp_link,
        name="create_srp_link",
    ),
    ...
    path(
        "doctrine/<int:pk>/ship/add/", views.add_doctrine_ship, name="add_doctrine_ship"
    ),
    path(
        "doctrine/ship/<int:pk>/remove/",
        views.remove_doctrine_ship,
        name="remove_doctrine_ship",
    ),
]
